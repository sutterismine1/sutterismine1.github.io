 ...
 return (
    ...
    {/* Title and Pronunciation Info */}
      ...
      <div className="social-media" data-nosnippet>
        <a href="https:/www.github.com/sutterismine1" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          <svg width="24px" height="24px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" focusable="false">
            <title>GitHub</title>
        ...
        <a href="https://www.linkedin.com/in/stephenstefanidis" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-linkedin" viewBox="0 0 16 16" role="img" aria-hidden="true" focusable="false">
